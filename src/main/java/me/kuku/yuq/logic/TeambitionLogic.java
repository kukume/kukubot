...
public interface TeambitionLogic {
	...
	Result<String> uploadToProject(TeambitionPojo teambitionPojo, InputStream is, Integer size, String...path) throws IOException;
	...
	Result<Boolean> panUploadFile(TeambitionPojo teambitionPojo, InputStream is, Integer size, String...path) throws IOException;
}
