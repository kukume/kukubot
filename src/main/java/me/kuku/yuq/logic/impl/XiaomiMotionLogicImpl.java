...
public class XiaomiMotionLogicImpl implements XiaomiMotionLogic {
    ...
    @Override
    public Result<String> login(String phone, String password) throws IOException {
...
//        map.put("token", "refresh");
        ...
        String access = BotUtils.regex("access=", "&", locationUrl);
    ...
    @Override
    public String changeStep(String token, int step) throws IOException {
        ...
        switch (jsonObject.getInteger("code")){
            ...
            case 0: return "步数修改失败，登录已失效！！";
            default: return "步数修改失败，未知错误！！";
        }
    }
}
