...
class NeTeaseLogicImpl: NeTeaseLogic {
    ...
    override fun loginByPhone(username: String, password: String): CommonResult<NeTeaseEntity> {
        ...
        return if (jsonObject.getInteger("code") == 200){
            CommonResult(200, "", NeTeaseEntity(null, 0L, cookieMap.getValue("MUSIC_U"), cookieMap.getValue("__csrf")))
        }else CommonResult(500, jsonObject.getString("message"))
    }

    override fun loginByQQ(qqLoginEntity: QQLoginEntity): CommonResult<NeTeaseEntity> {
        ...
        return if (commonResult.code == 200){
            ...
            else CommonResult(200, "", NeTeaseEntity(null, qqLoginEntity.qq, cookieMap.getValue("MUSIC_U"), cookieMap.getValue("__csrf")))
