...
class QQMailLogicImpl: QQMailLogic {
    ...
    override fun getFile(qqLoginEntity: QQLoginEntity): CommonResult<List<Map<String, String>>> {
        val commonResult = this.login(qqLoginEntity)
        return if (commonResult.code == 200){
    ...
    override fun fileRenew(qqLoginEntity: QQLoginEntity): String {
        val commonResult = this.getFile(qqLoginEntity)
        return if (commonResult.code == 200){
