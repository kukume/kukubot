...
object QQSuperLoginUtils {
    ...
    fun vipLogin(qqEntity: QQEntity): CommonResult<String>{
        return this.login(qqEntity, "8000212", "18", "ptlogin2.vip.qq.com", "&daid=18&pt_login_type=4&service=pt4_auth&pttype=2&regmaster=&aid=8000212&s_url=https%3A%2F%2Fzb.vip.qq.com%2Fsonic%2Fbubble")
    }

    fun blueLogin(qqEntity: QQEntity): CommonResult<String>{
        return this.login(qqEntity, "21000110", "176", "ptlogin2.gamevip.qq.com", "&daid=176&pt_login_type=4&service=pt4_auth&pttype=2&regmaster=&aid=21000110&s_url=http%3A%2F%2Fgamevip.qq.com%2F")
    }
